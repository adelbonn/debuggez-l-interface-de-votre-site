...
const retrieveSensorData = () => fetch('/debuggez-l-interface-de-votre-site/data/facade-detail-data.json')
...
const retrieveWeatherData = () => fetch('/debuggez-l-interface-de-votre-site/data/weather-api-mocked-data.json')
...
const main = async () => {
    ...
    const weatherForecastData = await retrieveWeatherData()



    if (sensorData && weatherForecastData) {
